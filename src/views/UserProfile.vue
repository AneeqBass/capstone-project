    ...
    <div class="container pb-4">
        <form id="editUserForm" v-if="user" @submit.prevent="updateUser">
            <div class="mb-3 text-center">
                <img class="imgUrl"
                    :src="user.imgUrl || 'https://codjoelmayer.github.io/projectImages/images/profile-Image.png'"
            ...
            <div class="mb-3">
                ...
                <input v-model="user.surname" type="text" class="form-control text-center" id="editUserSurname"
                    required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input v-model="user.email" type="email" class="form-control text-center" id="editUserEmail"
                    :class="{ 'is-invalid': !validEmail }" required>
            ...
            <div class="mb-3">
                ...
                <input v-model="user.password" type="password" class="form-control text-center" id="editUserPassword"
                    :class="{ 'is-invalid': !validPassword }" required>
            ...
            <div class="mb-3">
                ...
                <input v-model="user.role" type="text" class="form-control text-center" id="editUserRole"
                    :class="{ 'is-invalid': !validRole }" required>
  ...
  created() {
    ...
    methods: {
      ...
      if (currentUser) {
        ...
        fetchUser() {
            this.$store.dispatch('fetchUser', this.currentUser.id);
        },
        updateUser() {
            if (this.formIsValid) {
